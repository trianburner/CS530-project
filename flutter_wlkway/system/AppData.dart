///
/// AppData.dart handles the RGB & alarm times storage and modification
/// 
...
class Data { // Data object, holds all setters & getters
  ...
  void initPresets(BuildContext context) { // Called when conn first established
    sendColor(context);
    sendAlarm(context);
  }
